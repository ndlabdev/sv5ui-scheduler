...
export const fr: SchedulerLabels = {
    ...
    announce: {
        ...
        updated: (event) => `${event.title} mis à jour`,
        selected: (event) => `${event.title} sélectionné`,
        notEditable: (event) => `${event.title} ne peut pas être modifié`,
        cancelled: 'Annulé',
