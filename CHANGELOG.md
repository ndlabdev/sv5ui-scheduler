...
- **Scheduler**: snippets for `event`, `cell`, `header`, `eventDetail`, `eventPanel`, `createPanel`, `empty`, `toolbar` and `toolbarActions`; `toolbar={false}` hides the toolbar.
